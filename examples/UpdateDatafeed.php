...
$insertedDatafeed->setTitle("DEF Store Electronics products feed");
$updatedDatafeed = $client->updateDatafeed($insertedDatafeed);
echo 'Updated: ' . $updatedDatafeed->getTitle() . "\n";
