...
// Now delete the datafeed
$client->deleteDatafeed($insertedDatafeed);
echo "Delete succeeded\n";

// Verify the datafeed is deleted
$datafeedId = array_pop(explode('/', $editLink));
$errors = $client->getDatafeed($datafeedId);
